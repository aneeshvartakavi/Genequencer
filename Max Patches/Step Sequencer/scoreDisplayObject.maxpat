{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 44.0, 354.0, 73.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 44.0, 354.0, 73.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 667.0, 32.5, 18.0 ],
					"id" : "obj-24",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 618.0, 32.5, 18.0 ],
					"id" : "obj-20",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 155.0, 12.0, 106.0, 18.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 769.0, 106.0, 18.0 ],
					"presentation" : 1,
					"id" : "obj-11",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Getting the IP address\n",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 835.0, 150.0, 20.0 ],
					"id" : "obj-6",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Your Current IP Address:",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"presentation_rect" : [ 11.0, 10.0, 150.0, 20.0 ],
					"patching_rect" : [ 146.0, 198.0, 150.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-21",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 695.0, 104.0, 20.0 ],
					"id" : "obj-13",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 259.0, 656.0, 131.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 3,
					"items" : [ "fe80:0:0:0:1240:f3ff:fea4:7a04%5", ",", "143.215.59.10" ],
					"outlettype" : [ "int", "", "" ],
					"types" : [  ],
					"patching_rect" : [ 87.0, 694.0, 109.0, 20.0 ],
					"id" : "obj-15",
					"labelclick" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"types" : [  ],
					"patching_rect" : [ 155.0, 658.0, 100.0, 20.0 ],
					"id" : "obj-16",
					"labelclick" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 87.0, 583.0, 20.0, 20.0 ],
					"id" : "obj-17"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 87.0, 630.0, 87.0, 20.0 ],
					"id" : "obj-18",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 107.0, 583.0, 393.0, 20.0 ],
					"id" : "obj-2",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 18.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 8.0, 34.0, 305.0, 25.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 205.0, 685.0, 398.0, 685.0, 398.0, 623.0, 96.5, 623.0 ]
				}
