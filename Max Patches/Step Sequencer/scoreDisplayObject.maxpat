{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 44.0, 334.0, 65.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 44.0, 334.0, 65.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 187.0, 13.0, 106.0, 18.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Click to get your IP address : ",
					"linecount" : 2,
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"presentation_rect" : [ 11.0, 10.0, 168.0, 20.0 ],
					"patching_rect" : [ 146.0, 198.0, 150.0, 34.0 ],
					"presentation" : 1,
					"id" : "obj-21",
					"fontname" : "Arial"
				}
